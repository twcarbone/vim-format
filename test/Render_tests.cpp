...
TEST_F(RenderTest, column_simple)
{
    ...
    test_file("test/column/simple_heredoc.in.vim", "test/column/simple_heredoc.out.vim");
    test_file("test/column/simple_control.in.vim", "test/column/simple_control.out.vim");
